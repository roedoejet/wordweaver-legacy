...
def export(prune, compress):
    ...
    args = {
        "root": verb_tags,
        "agent": pronoun_tags,
        "patient": pronoun_tags,
        "aff-option": option_tags,
    }
    ...
    for tag in tqdm(tags):
        input_args = {
            "root": tag["http_args"]["root"],
            "agent": tag["http_args"]["agent"],
            "patient": tag["http_args"]["patient"],
            "option": tag["http_args"]["affopt"],
        }
